...
console.log(validateFormatting("i17on", "i18n")); // true
console.log(validateFormatting("internationalization", "i18n")); // true
console.log(validateFormatting("", "")); // true
console.log(validateFormatting("ac", "ac")); // true
console.log(validateFormatting("ac", "a0c")); // true
